              ...
              return (
                ...
                >
                  <p className="mb-1 flex items-center gap-2 text-xs text-gray-500">
                    ...
                    <span>{c.commenter_display_name || c.commenter_username || `#${c.commenter_user_id}`}</span>
                    <span>·</span>
                        ...
                        <li key={r.id} className="rounded-lg bg-white/80 p-2.5">
                          <p className="mb-1 flex items-center gap-2 text-xs text-gray-400">
                            <span className="font-medium text-gray-600">
                              {r.commenter_display_name || r.commenter_username || `#${r.commenter_user_id}`}
                            </span>
                            <span>·</span>
    ...
    <div className="rounded-2xl border border-amber-200 bg-amber-50/60 p-5">
      <div className="flex flex-wrap items-baseline justify-between gap-2">
        ...
        <p className="text-xs text-amber-900/60">
          {(comment.commenter_display_name || comment.commenter_username) && <span>{comment.commenter_display_name || comment.commenter_username}</span>}
